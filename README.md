...
### 2. Стационарное уравнение Навье–Стокса (диффузия в пористой среде)
...
- **Вход:** число Рейнольдса $Re \in [50, 400]$ + описание геометрии
- **Выход:** поле скорости $u(x,y)$ и поле давления $p(x,y)$
- **Данные:** FEM (MATLAB/Firedrake), CSV на сетке $128 \times 128$
---

### 3. Нестационарные уравнения Навье–Стокса (DNS + осреднение)
