...
# --- КОНФИГУРАЦИЯ ---
# Папки с данными
MSH_FOLDER = "../../test_sev_part_obj"           # Где лежат MSH файлы
INTERP_RESULTS_DIR = "../final_test_sev_dataset"         # Где лежат x_data.csv и y_data.csv
OUTPUT_DIR = "./test_sev_dataset_output"                 # Куда сохранять U.csv, C.csv и картинки
...
def extract_id_from_filename(filename):
    ...
    match = re.search(r'sev_(\d+)\.msh', basename)
    if match:
